...
import 'CustomCodeVerificationWidget.dart';

class CustomPhoneInputWidget extends StatefulWidget {

  @override
  _CustomPhoneInputWidgetState createState() => _CustomPhoneInputWidgetState();
}

class _CustomPhoneInputWidgetState extends State<CustomPhoneInputWidget> {
  ...
  late CustomCodeVerificationWidget codeVerificationWidget;
  ...
  Future<void> verifyPhoneNumber(
    ...
    setState(() {
      _isLoading = true; // Set loading state to true before starting verification
    });
    await _auth.verifyPhoneNumber(
      ...
      codeSent: (String verificationId, int? resendToken) {
        ...
        _isLoading = false; // Set loading state to false after code is sent
        codeVerificationWidget.showVerificationBottomSheet(
            context, _verificationId, phoneNumber);
      },
  ...
  void initState() {
    ...
    codeVerificationWidget =
        CustomCodeVerificationWidget(_auth); // Initialize the widget
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            FutureBuilder(
              future: Future.delayed(Duration(seconds: 0)), // Simulate async operation
              builder: (context, snapshot) {
                if (_isLoading) {
                  // Show loading screen while waiting for verification
                  return CircularProgressIndicator();
                } else {
                  // Show phone input form when not loading
                  return Row(
